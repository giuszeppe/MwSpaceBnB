...
<html class="no-js" lang="zxx">
  ...
  <body class="tg-home tg-homevone">
          ...
          <div class="row">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <span
                      ...
                      <a href="javascript:void(0);">Discover more</a></span
                    >
                  </li>
                </ul>
              </nav>
            ...
            <div class="tg-navigationarea tg-headerfixed">
              <strong class="tg-logo"
                ><a href="index.html"
                  ><img src="/images/logo.png" alt="company logo here" /></a
              ></strong>
              <div class="tg-socialsignin">
                <ul class="tg-socialicons">
                  ...
                  <li>
                    <a href="javascript:void(0);"
                      ><i class="icon-instagram-social-outlined-logo"></i
                    ></a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"
                ...
                <div class="tg-userbox">
                  ...
                  <div class="dropdown tg-dropdown">
                    ...
                    <ul
                      class="dropdown-menu tg-dropdownusermenu"
                    ...
                    <li class="menu-item-has-children current-menu-item">
                      ...
                      <ul class="sub-menu">
                        <li class="current-menu-item">
                          <a href="index.html">Home ~ Modern</a>
                        </li>
                        <li><a href="indexv2.html">Home ~ Full Screen</a></li>
                        <li><a href="indexv3.html">Home ~ Creative</a></li>
                        <li><a href="indexv4.html">Home ~ Simple</a></li>
                    ...
                    <li class="menu-item-has-children menu-item-has-mega-menu">
                      ...
                      <div class="mega-menu">
                        <ul>
                          ...
                          <li><a href="listingvtwo.html">list style two</a></li>
                          <li>
                            <a href="listingvthree.html">list style three</a>
                          </li>
                          <li>
                            <a href="listingvfour.html">list style four</a>
                          </li>
                          <li>
                            <a href="listingvfive.html">list style five</a>
                          </li>
                          <li><a href="listingvsix.html">list style six</a></li>
                        </ul>
                        <div class="tg-sliderarea">
                    ...
                    <li class="menu-item-has-children">
                      ...
                      <ul class="sub-menu">
                        ...
                        <li class="menu-item-has-children">
                          ...
                          <ul class="sub-menu">
                            <li>
                              <a href="tourcatagory.html">Tour Catagory</a>
                            </li>
                            <li>
                              <a href="tourbookingdetail.html">Tour Detail</a>
                            </li>
                            <li>
                              <a href="tourpaymentdetail.html">Tour Payment</a>
                            </li>
                          </ul>
                        </li>
                      </ul>
      ...
      <main id="tg-main" class="tg-main tg-haslayout">
            ...
            <div class="row">
              <div class="tg-ourdestination">
                ...
                >
                  <figure>
                    <img
                      src="/images/placeholder/placeholder-01.png"
                      alt="image destinations"
                    />
                  </figure>
                </div>
                ...
                >
                  <div class="tg-ourdestinationcontent">
                    ...
                    <a class="tg-btn" href="tourcatagory.html"
                      ><span>all destinations</span></a
                    >
                  </div>
                </div>
              </div>
        ...
        <section class="tg-sectionspace tg-zerotoppadding tg-haslayout">
          <div class="container">
            <div class="row">
              <div
                id="tg-destinationsslider"
                class="tg-destinationsslider tg-destinations owl-carousel"
              >
                <div class="item tg-destination">
                  <figure>
                    <a href="tourbookingdetail.html"
                      ><img
                        src="/images/destination/img-04.jpg"
                        alt="image description"
                    /></a>
                    <figcaption>
                ...
                <div class="item tg-destination">
                  <figure>
                    <a href="tourbookingdetail.html"
                      ><img
                        src="/images/destination/img-05.jpg"
                        alt="image description"
                    /></a>
                    <figcaption>
                  ...
                  <figure>
                    <a href="tourbookingdetail.html"
                      ><img
                        src="/images/destination/img-06.jpg"
                        alt="image description"
                    /></a>
                    <figcaption>
                ...
                <div class="item tg-destination">
                  <figure>
                    <a href="javascript:void(0);"
                      ><img
                        src="/images/destination/img-07.jpg"
                        alt="image description"
                    /></a>
                    <figcaption>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <div class="tg-calltoaction">
                    <div class="tg-pattern">
                      <img src="/images/patternw.png" alt="image destination" />
                    </div>
                    <h2>Get 10% Off on your Next Travel</h2>
                    <div class="tg-description">
                      <p>
                        Travel between 22 April to 21 May and get existing
                        offers along with a sure 10% cash discount
                      </p>
                    </div>
                    <a class="tg-btn" href="javascript:void(0);"
                      ><span>Explore Tour</span></a
                    >
                  </div>
                </div>
              </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div
                  id="tg-guidesslider"
                  class="tg-guidesslider tg-guides owl-carousel"
                >
                  <div class="item tg-guide">
                    <figure>
                      <img
                        src="/images/Guides/img-01.jpg"
                      ...
                      <div class="tg-guidecontenthead">
                        ...
                        <ul class="tg-socialicons tg-socialiconsvtwo">
                          ...
                          <li>
                            <a href="javascript:void(0);"
                              ><i
                                class="icon-instagram-social-outlined-logo"
                              ></i
                            ></a>
                          </li>
                          <li>
                    ...
                    <ul class="tg-partners">
                      <li>
                        <figure>
                          <a href="javascript:void(0);"
                            ><img
                              src="/images/partners/img-01.png"
                              alt="image destinations"
                          /></a>
                        </figure>
                      </li>
                      <li>
                        <figure>
                          <a href="javascript:void(0);"
                            ><img
                              src="/images/partners/img-02.png"
                              alt="image destinations"
                          /></a>
                        </figure>
                      </li>
                      <li>
                        <figure>
                          <a href="javascript:void(0);"
                            ><img
                              src="/images/partners/img-03.png"
                              alt="image destinations"
                          /></a>
                        </figure>
                      </li>
                      <li>
                        <figure>
                          <a href="javascript:void(0);"
                            ><img
                              src="/images/partners/img-04.png"
                              alt="image destinations"
                          /></a>
                        </figure>
                      </li>
                      <li>
                        <figure>
                          <a href="javascript:void(0);"
                            ><img
                              src="/images/partners/img-05.png"
                              alt="image destinations"
                          /></a>
                        </figure>
                      </li>
              ...
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                <div class="tg-footercolumn tg-widget tg-widgettext">
                  ...
                  <div class="tg-widgetcontent">
                    <div class="tg-description">
                      <p>
                        Nunc cursus liero purs ac cogue arcu cursus ut sed vitae
                    ...
                    <ul>
                      <li>
                        ...
                        <div class="tg-newcontent">
                          ...
                          <div class="tg-description">
                            <p>
                              Nunc cursus libero purus congue arcu vitae
                              pulvinar
                            </p>
                          </div>
              ...
              <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                <div class="tg-footercolumn tg-widget tg-widgetdestinations">
                  ...
                  <div class="tg-widgetcontent">
                    <ul>
                      <li>
                        <a href="javascript:void(0);">Bayonne, Melbourne</a>
                      </li>
                      <li>
                        <a href="javascript:void(0);">Greenville, New Jersey</a>
                      </li>
                      <li>
                        <a href="javascript:void(0);">The Heights, London</a>
                      </li>
                      <li>
                        <a href="javascript:void(0);">West Side, New York</a>
                      </li>
                      <li>
                        <a href="javascript:void(0);"
	...
	*************************************-->
    <div
      id="tg-loginsingup"
      class="tg-loginsingup"
      data-vide-bg="poster: images/singup-img.jpg"
      data-vide-options="position: 0% 50%"
    >
            ...
            <div class="tg-themetabs">
              <ul class="tg-navtbs" role="tablist">
                <li role="presentation" class="active">
                  <a href="#home" data-toggle="tab">Already Registered</a>
                </li>
                <li role="presentation">
                  <a href="#profile" data-toggle="tab">New to Travleu ?</a>
                </li>
              </ul>
            ...
            <div class="tg-signupwith">
              ...
              <ul class="tg-sharesocialicon">
                <li class="tg-facebook">
                  <a href="#"
                    ><i class="icon-facebook-1"></i><span>Facebook</span></a
                  >
                </li>
                <li class="tg-twitter">
                  <a href="#"
                    ><i class="icon-twitter-1"></i><span>Twitter</span></a
                  >
                </li>
                <li class="tg-googleplus">
                  <a href="#"
                    ><i class="icon-google4"></i><span>Google+</span></a
                  >
                </li>
              </ul>
            </div>
